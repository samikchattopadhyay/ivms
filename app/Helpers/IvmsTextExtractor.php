...
class IvmsTextExtractor
{
    ...
    /**
     * Parse zipped document, i.e.
     * .docx or .odt (adapted from http://goo.gl/usI7PF)
     *
     * @param string $filename
     *            The path to the document
     * @param string $datafile
     *            .odt and .docx documents are just zipped folders with an XML file. This variable is the path to the main
     ...
     *            The xml document describing the word file
     */
     ...
     *            The name of the tag to test for emptiness
     */
    ...
    /**
     * Rename a DOMElement (i.e.
     * rename a tag, e.g. i -> em). (adapted from http://goo.gl/Crll0b)
     *
     ...
     *            The XML document from which to remove nodes
     * @param string|array $tagnames
     *            A comma separated list of tagnames to remove
     */
